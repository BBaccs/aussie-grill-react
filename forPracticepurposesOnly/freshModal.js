      ...
      >
        ...
        <Modal.Body>
          <div className="modal-footer justify-content-center p-0 doordash-uber-wrapper">
            <div id="doordash-div">
R              <a className="d-block" target="_blank" rel="noopener noreferrer" href={deliveryUrl} >
            ...
            <div id="uber-eats-div">
              <a className="d-block" target="_blank" rel="noopener noreferrer" href={deliveryUrl} >
