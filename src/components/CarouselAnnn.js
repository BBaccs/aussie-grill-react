        ...
        return (
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    {/* <!-- Responsive pictures --> */}
                    <picture>
                        <source srcset={`assets/carouselImages/desktop/lg-baconBombBurgerHero2000x800.jpg`}
                            media="(min-width: 1400px)" />
                        <source srcset="assets/carouselImages/tablet/md-baconBombBurgerHero1024x600.jpg"
                            media="(min-width: 700px) and (max-width: 1400px)" />
                        <img src="assets/carouselImages/mobile/sm-baconBombBurgerHero375x280.jpg"
                            class="d-block w-100 carousel-img" alt="Soooooo Much Bacon" />
                    </picture>
                </div>
