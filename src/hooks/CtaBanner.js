        ...
        <div className="cta-wrapper">
            <div className="d-flex container-fluid justify-content-between align-items-center cta-banner">
                ...
                {location.pathname.includes('catering') ?
                    <a href="https://www.ezcater.com/brand/pvt/aussie-grill" target="_blank" className="btn btn-primary">Order Catering</a>
                    :
                    <Link to="/pickup" className="btn btn-primary">Order now</Link>
                }
            </div>
        </div>
    );
